...
function NightTransition({ fading }: { fading: boolean }) {
  return (
    <div
      className={`fixed inset-0 z-[100] pointer-events-none flex items-center justify-center transition-opacity duration-700 ${fading ? 'opacity-0' : 'opacity-100'}`}
    >
      {/* Dark overlay */}
      ...
      <div className="relative animate-[moon-rise_1.2s_ease-out_both]">
        <div className="relative">
          {/* Moon glow */}
          <div className="absolute inset-0 -m-8 rounded-full bg-indigo-400/20 blur-3xl animate-pulse" />
          {/* Moon body */}
          <svg width="120" height="120" viewBox="0 0 120 120" className="drop-shadow-[0_0_30px_rgba(199,210,254,0.4)]">
            <defs>
      ...
      {/* Text */}
      <div className="absolute bottom-1/3 text-center animate-[fade-up_1s_ease-out_0.5s_both]">
        <p className="text-3xl font-display font-bold tracking-[0.3em] text-indigo-200/90">
          夜幕降临
        </p>
        <p className="text-sm text-indigo-300/50 mt-2 tracking-widest">
          NIGHT FALLS
        </p>
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      <div className="relative animate-[sun-rise_1.2s_ease-out_both]">
        ...
        <div className="relative">
          {/* Sun glow */}
          <div className="absolute inset-0 -m-12 rounded-full bg-amber-400/25 blur-3xl animate-pulse" />
          <div className="absolute inset-0 -m-6 rounded-full bg-orange-300/15 blur-2xl" />
          {/* Sun body */}
          <svg width="120" height="120" viewBox="0 0 120 120" className="drop-shadow-[0_0_40px_rgba(251,191,36,0.5)]">
            <defs>
      ...
      {/* Text */}
      <div className="absolute bottom-1/3 text-center animate-[fade-up_1s_ease-out_0.5s_both]">
        <p className="text-3xl font-display font-bold tracking-[0.3em] text-amber-200/90">
          天亮了
        </p>
        <p className="text-sm text-amber-300/50 mt-2 tracking-widest">
          DAY BREAKS
        </p>
      </div>
    </div>
